...
def scrap_produto(link):
    ...
    info_produto = bsObj.find("dl", {"class": "dl-horizontal"}).findChild()

    print("Produto: "+nome_prduto.attrs["content"])
    if hasattr(cest_produto,"text"):
        print(cest_produto.text[1:9])
    ...
    for i in range(len(lista_ean_gtin)):
        ...
        '''
    print( 7, info_produto[7])
    print( 8, info_produto[8] )


scrap_produto("https://cosmos.bluesoft.com.br/products/7898215152811")